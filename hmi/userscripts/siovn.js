...
// copyright 2017
// Версия: 1.0.0
// Модуль siovn.js реализует анимацию и логику диалогового взаимодействия для видеокадра siovn.
//////////////////////////////////////////////////////////////////////////////////////////////
...
function init() {
	...
	setHighlightButton('ZDN_LVD_G','changeRefValue(\'ZDN_LVD_VN\',-150,150,\'Задание уровня в барабане-сепараторе СИО ВН\');');
	setHighlightButton('PR_TRENDS_BUTTON','showTrendByID(\'SIOVN_PR_TRENDS\');');
	setHighlightButton('VD_TRENDS_1_BUTTON','showTrendByID(\'SIOVN_VD_TRENDS\');');
	setHighlightButton('VD_TRENDS_2_BUTTON','showTrendByID(\'SIOVN_VD_TRENDS\');');
	setHighlightButton('NASSIO_BUTTON','nassio_click();');
	setImmediateButton('LVD_MAN_MIN_BUTTON','setBoolTag(\'LVD_VN_MAN_MIN\',true);','setBoolTag(\'LVD_VN_MAN_MIN\',false);');
	setImmediateButton('LVD_MAN_MAX_BUTTON','setBoolTag(\'LVD_VN_MAN_MAX\',true);','setBoolTag(\'LVD_VN_MAN_MAX\',false);');
	setHighlightButton('LVD_REGR_BUTTON','clickModeButton(\'LVD_VN\',\'уровнем в барабане-сепараторе СИО воздухонагревателей\');');
...
function animate_fields() {
	var GVDPIT=getFltTag('GVDPIT_VN');
	var FVD_PIT_1=getFltTag('FVD_PIT_VN_1');
	var FVD_PIT_2=getFltTag('FVD_PIT_VN_2');
	var PVD_PIT_1=getFltTag('PVD_PIT_VN_1');
	var PVD_PIT_2=getFltTag('PVD_PIT_VN_2');
	var LVD_1=getFltTag('LVD_1_VN');
	var PPR=getFltTag('PPR_VN');
	var FPR_SIO=getFltTag('FPR_SIO_VN');
	var PPR_SIO=getFltTag('PPR_SIO_VN');
	var TPR_SIO=getFltTag('TPR_SIO_VN');
	var FVD_1=getFltTag('FVD_VN_1');
	var FVD_2=getFltTag('FVD_VN_2');
	var FVD_3=getFltTag('FVD_VN_3');
	var FVD_4=getFltTag('FVD_VN_4');
	var PVD_1=getFltTag('PVD_VN_1');
	var PVD_2=getFltTag('PVD_VN_2');
	var PVD_3=getFltTag('PVD_VN_3');
	var PVD_4=getFltTag('PVD_VN_4');
	var TVD_1=getFltTag('TVD_VN_1');
	var TVD_2=getFltTag('TVD_VN_2');
	var TVD_3=getFltTag('TVD_VN_3');
	var TVD_4=getFltTag('TVD_VN_4');
	...
	var PPR_1=getFltTag('PPR_VN_1');
	var PPR_2=getFltTag('PPR_VN_2');
	var PPR_3=getFltTag('PPR_VN_3');
	var PPR_4=getFltTag('PPR_VN_4');
	var TPR_1=getFltTag('TPR_VN_1');
	var TPR_2=getFltTag('TPR_VN_2');
	var TPR_3=getFltTag('TPR_VN_3');
	var TPR_4=getFltTag('TPR_VN_4');
	var PPR_0_1=getFltTag('PPR_0_1');
	var PPR_0_2=getFltTag('PPR_0_2');
	var QCO=getFltTag('QCO_VN');
	var QCO_NAS_1=getFltTag('QCO_NAS_1');
	var QCO_NAS_2=getFltTag('QCO_NAS_2');
	var ZDN_LVD=getFltTag('ZDN_LVD_VN');

	setText('LVD_REGR',getBoolTag('LVD_VN_REGR') ? 'А' : 'Д' );
	...
	animateButton('LVD_MAN_MIN',getBoolTag('LVD_VN_MAN_MIN'));
	animateButton('LVD_MAN_MAX',getBoolTag('LVD_VN_MAN_MAX'));

	animateAlarmStroke('GVDPIT_BACK','GVDPIT_VN');
	animateAlarmStroke('FVD_PIT_1_BACK','FVD_PIT_1');
	animateAlarmStroke('PVD_PIT_1_BACK','PVD_1');
	animateAlarmStroke('FVD_PIT_2_BACK','FVD_PIT_2');
	animateAlarmStroke('PVD_PIT_2_BACK','PVD_2');
	animateAlarmStroke('LVD_1_BACK','LVD_1_VN');
	animateAlarmStroke('PPR_BACK','PPR_VN');
	animateAlarmStroke('FPR_SIO_BACK','FPR_SIO_VN');
	animateAlarmStroke('PPR_SIO_BACK','PPR_SIO_VN');
	animateAlarmStroke('TPR_SIO_BACK','TPR_SIO_VN');
	animateAlarmStroke('FVD_1_BACK','FVD_VN_1');
	animateAlarmStroke('PVD_1_BACK','PVD_VN_1');
	animateAlarmStroke('TVD_1_BACK','TVD_VN_1');
	animateAlarmStroke('FVD_2_BACK','FVD_VN_2');
	animateAlarmStroke('PVD_2_BACK','PVD_VN_2');
	animateAlarmStroke('TVD_2_BACK','TVD_VN_2');
	animateAlarmStroke('FVD_3_BACK','FVD_VN_3');
	animateAlarmStroke('PVD_3_BACK','PVD_VN_3');
	animateAlarmStroke('TVD_3_BACK','TVD_VN_3');
	animateAlarmStroke('FVD_4_BACK','FVD_VN_4');
	animateAlarmStroke('PVD_4_BACK','PVD_VN_4');
	animateAlarmStroke('TVD_4_BACK','TVD_VN_4');
	...
	animateAlarmStroke('PPR_1_BACK','PPR_VN_1');
	animateAlarmStroke('PPR_2_BACK','PPR_VN_2');
	animateAlarmStroke('PPR_3_BACK','PPR_VN_3');
	animateAlarmStroke('PPR_4_BACK','PPR_VN_4');
	animateAlarmStroke('TPR_1_BACK','TPR_VN_1');
	animateAlarmStroke('TPR_2_BACK','TPR_VN_2');
	animateAlarmStroke('TPR_3_BACK','TPR_VN_3');
	animateAlarmStroke('TPR_4_BACK','TPR_VN_4');
	animateAlarmStroke('PPR_0_1_BACK','PPR_0_1');
	animateAlarmStroke('PPR_0_2_BACK','PPR_0_2');
	animateAlarmStroke('QCO_BACK','QCO_VN');
	animateAlarmStroke('QCO_NAS_1_BACK','QCO_NAS_1');
	animateAlarmStroke('QCO_NAS_2_BACK','QCO_NAS_2');

	animateAlarmFill('LVD_1_G','LVD_1_VN');
