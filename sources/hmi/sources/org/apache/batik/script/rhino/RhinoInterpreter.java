    ...
    public RhinoInterpreter(final URL documentURL) {
        ...
        ContextAction initAction = new ContextAction() {
            public Object run(Context cx) {
                ...
                sb.append(')');
                cx.evaluateString(globalObject, sb.toString(), documentURL.getFile()+"#imports", 0,
                                  rhinoClassLoader);
                return null;
            }
        };
    ...
    public Object evaluate(final String scriptStr) {
        ...
        ContextAction evalAction = new ContextAction() {
            public Object run(final Context cx) {
                ...
                if (cx.getSecurityController()==null) {
...
//                    }
        ...
        try {
            Object evaluateResult=contextFactory.call(evalAction);
            evalAction=null;
