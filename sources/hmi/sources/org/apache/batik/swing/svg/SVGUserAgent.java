...
public interface SVGUserAgent {
    ...
    void showSetFullscreen(boolean fullscreen);
    
    void addKeyAction(WindowWrapper.FunctionWrapper fw,long key, long mask);

    void showPopupMenu(JPopupMenu menu);

    void showCloseWindow();
    
    void showOpenURL(String url,boolean newwindow);
    
    void showOpenURLWithParameters(String url,boolean newwindow,String initialScript);
    ...
    void openLinkWithParameters(String uri, boolean newc,String initialScript);
