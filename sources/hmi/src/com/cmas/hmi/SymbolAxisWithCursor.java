 ...
 * @author vns
 */
public class SymbolAxisWithCursor extends SymbolAxis {

    private double cursorValue=0.0;

    public SymbolAxisWithCursor(String label,String[] sv) {
        super(label,sv);
    }

    public SymbolAxisWithCursor(String label) {
        super(label,new String[0]);
    }

    public SymbolAxisWithCursor() {
        super("",new String[0]);
    }
