...
public interface Application {
     ...
     */
    boolean closeJSVGViewerFrame(JSVGViewerFrame referer);
     ...
     */
    void openLink(String url, JSVGViewerFrame referer);
    void openLink(String url, JSVGViewerFrame referer, boolean visible);
    void openLinkWithParameters(String url, JSVGViewerFrame referer, String initialScript);
    void openLinkWithParameters(String url, JSVGViewerFrame referer, boolean visible,String initialScript);

    void removeViewerFrame(String url);
    /**
