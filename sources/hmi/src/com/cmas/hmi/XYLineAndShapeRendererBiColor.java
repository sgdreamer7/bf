 ...
 * class.
 */
public class XYLineAndShapeRendererBiColor extends AbstractXYItemRenderer
     ...
     */
    public XYLineAndShapeRendererBiColor() {
        this(true, true);
    }
     ...
     */
    public XYLineAndShapeRendererBiColor(boolean lines, boolean shapes) {
    ...
    protected void drawPrimaryLine(XYItemRendererState state,
        ...
        if (y1<y0) {
            p=new Color(0xFFFFFF-((Color)p).getRGB());
//            Color clr=(Color)p;
//            p=new Color((int)(clr.getRed()*0.25),(int)(clr.getGreen()*0.25),(int)(clr.getBlue()*0.25));
        }
...
//        double x1 = dataset.getXValue(series, item);
//        double y1 = dataset.getYValue(series, item);
            drawFirstPassShape(g2, pass, series, item, state.workingLine,p);
        }
    }
    ...
    protected void drawPrimaryLineAsPath(XYItemRendererState state,
        ...
        if (item == s.getLastItemIndex()) {
            // draw path
            drawFirstPassShape(g2, pass, series, item, s.seriesPath,p);
        }
    }
    ...
    public Object clone() throws CloneNotSupportedException {
        XYLineAndShapeRendererBiColor clone = (XYLineAndShapeRendererBiColor) super.clone();
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof XYLineAndShapeRendererBiColor)) {
            return false;
        }
        if (!super.equals(obj)) {
            return false;
        }
        XYLineAndShapeRendererBiColor that = (XYLineAndShapeRendererBiColor) obj;
