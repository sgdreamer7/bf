...
%% @copyright 2017
%% @version 1.0.0
%% @doc Модуль <b>alarm_messages2.erl</b> реализует формирование данных
%% для протокола аварийных и предупредительных сообщений по загрузке.
%% @end
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
-include("reports.hrl").
