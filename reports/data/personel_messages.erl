...
%% @copyright 2017
%% @version 1.0.0
%% @doc Модуль <b>personel_messages.erl</b> реализует формирование данных
%% для сменного протокола действий технологического персонала.
%% @end
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
-include("reports.hrl").
...
data({struct,Props}) ->
	...
	{ok,
		[
			{"name","Сменный протокол действий технологического персонала"},
