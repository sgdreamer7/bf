...
%% @copyright 2017
%% @version 1.0.0
%% @doc Модуль <b>progs.erl</b> реализует формирование данных
%% для протокола подач по загрузке доменной печи.
%% @end
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
-include("reports.hrl").
...
data({struct,Props}) ->
	...
	{Progs,_,_,_,_}=get_period_data(ReportDate,ReportDate2),
	{ok,
		[
			{"name","Протокол подач"},
