...
%% @copyright 2017
%% @version 1.0.0
%% @doc Модуль <b>journal13.erl</b> реализует формирование данных
%% для документа печного журнала <Параметры газодинамики>.
%% @end
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
-include("reports.hrl").
...
data({struct,Props}) ->
	...
	{ok,
		[
			{"name","Печной журнал. Параметры газодинамики."},
