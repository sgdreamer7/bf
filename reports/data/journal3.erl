...
%% @copyright 2017
%% @version 1.0.0
%% @doc Модуль <b>journal3.erl</b> реализует формирование данных
%% для документа печного журнала <Выпуск чугуна>.
%% @end
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
-include("reports.hrl").
...
data({struct,Props}) ->
	...
	{Shift1Rows2,Shift1Row2}=get_shift_data2(ShiftStart1),
	{Shift2Rows2,Shift2Row2}=get_shift_data2(ShiftStart2),
	{Shift3Rows2,Shift3Row2}=get_shift_data2(ShiftStart3),
	{ok,
		[
			{"name","Печной журнал. Выпуск чугуна."},
			...
			{"name2","Печной журнал. Выпуск шлака."},
			{"shift1_rows2",Shift1Rows2},
			{"shift2_rows2",Shift2Rows2},
			{"shift3_rows2",Shift3Rows2},
			{"shift1_row2",Shift1Row2},
			{"shift2_row2",Shift2Row2},
			{"shift3_row2",Shift3Row2}
		]
	};
data(_) ->
	{ok,[]}.
...
get_shift_data(ShiftStart) ->
	...
	{ShiftRows,ShiftRow}=lists:foldr(
		fun(Row,{ShiftRowsAccIn,ShiftRowAccIn}) ->
			...
			NewShiftRows=[[NUM,NTAP,format_time(DTGRAPHIC),format_time(DTBEGIN),DTBEGINDIF,format_time(DTENDGRAPHIC),format_time(DTEND),DTBEGINDIF,SCOOPCOUNT,CALCMASS,W1_4+W2_4+W3_4+W4_4+W5_4+W6_4+W7_4+W8_4+W9_4+W10_4,W1_4+W2_4+W3_4+W4_4+W5_4+W6_4+W7_4+W8_4+W9_4+W10_4-CALCMASS,TEMP,TEMP,SI,MN,S,CR,0.0,0.0,"-","-","-"]|ShiftRowsAccIn],
			NewShiftRow=[A+B || {A,B} <- lists:zip([SCOOPCOUNT,CALCMASS,W1_4+W2_4+W3_4+W4_4+W5_4+W6_4+W7_4+W8_4+W9_4+W10_4,W1_4+W2_4+W3_4+W4_4+W5_4+W6_4+W7_4+W8_4+W9_4+W10_4-CALCMASS],ShiftRowAccIn)],
