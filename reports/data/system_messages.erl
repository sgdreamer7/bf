...
%% @copyright 2017
%% @version 1.0.0
%% @doc Модуль <b>system_messages.erl</b> реализует формирование данных
%% для сменного протокола системной регистрации работы рабочей станции.
%% @end
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
-include("reports.hrl").
...
data({struct,Props}) ->
	...
	{ok,
		[
			{"name","Сменный протокол системной регистрации работы рабочей станции"},
